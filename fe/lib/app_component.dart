...
import 'package:fe/src/fail_card/fail_card_component.dart';
...
@Component(
  ...
  directives: [NgIf, UploadCard, UploadingCard, UploadedCard, CopyInput, FailCard],
)
class AppComponent {
  ...
  final String fail = UploadStage.FAIL.toString();
